  ...
  return (
    <div className="min-h-screen bg-[#262626] text-white py-20">
      <div className="container mx-auto px-4">
        <h1 className="text-4xl md:text-5xl font-bold gradient-text mb-12 text-center">Demo Day Showcase</h1>
        <div className="max-w-3xl mx-auto mb-12">
          <p className="text-xl text-gray-300 mb-6 text-center">
            Demo Day is the culmination of our Innovation Club's hard work and creativity. It's an opportunity for our
